    ...
    <div class="project-detail-content">
            ...
            <div class="section">
                ...
                <ul class="detail-list">
                    <li>El script lee la información de los aprendices desde un archivo Excel (.xls). El robot se autentica en el sistema, navega al formulario de registro de candidatos y realiza una búsqueda de validación por documento.</li>
                </ul>
            </div>
